...
from lib.models.layers.super_layers import SuperConv2d, SuperBatchNorm2d, SuperUpConv, SuperFusedMBConv
...
class SuperLitePose(nn.Module):
    ...
    def _make_final_layers(self, cfg, num_filters):
        ...
        for i in range(1, extra.NUM_DECONV_LAYERS):
            ...
            final_refined.append(SuperConv2d(num_filters[i], oup_joint + oup_tag, 3, 1, 1, bias=True))
            final_raw.append(SuperConv2d(self.channel[-i-3], oup_joint + oup_tag, 3, 1, 1, bias=True))
